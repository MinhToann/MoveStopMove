...
{
    private static Dictionary<ShopItemType, Pool> dicGU = new Dictionary<ShopItemType, Pool>();
    ...
    public static T Spawn<T>(ShopItemType poolType, Vector3 pos, Quaternion rot) where T : GameUnit
    {
